...
public class IncrementalIndexTest
{
  ...
  public void testNullDimensionTransform() throws IndexSizeExceededException
  {
    ...
    if (NullHandling.replaceWithDefault()) {
      Assert.assertEquals(Arrays.asList("", "", "A"), row.getRaw("string"));
      Assert.assertEquals(
          Arrays.asList("", "", String.valueOf(Float.POSITIVE_INFINITY)),
          row.getRaw("float")
      );
      Assert.assertEquals(Arrays.asList("", "", String.valueOf(Long.MIN_VALUE)), row.getRaw("long"));
    } else {
