...
public class MovingAverageCollectorTest
{
  @Test
  public void testCollection() throws Exception
  {
    final MovingAverageCollector collector = new MovingAverageCollector(
        1,
        10,
        new TaskMetricsGetter()
        {
          ...
          public Map<String, Number> getTotalMetrics()
          {
            synchronized (this) {
              if (counter > 20) {
                return MovingAverageCollector.STOP_SIGNAL;
              }
              ...
              Map<String, Number> ret = ImmutableMap.of(
                  "a", a,
                  "b", b,
                  "c", c
              );
