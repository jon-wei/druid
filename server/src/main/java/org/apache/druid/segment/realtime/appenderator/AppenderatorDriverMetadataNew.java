...
public class AppenderatorDriverMetadataNew
{
  private static final Logger log = new Logger(AppenderatorDriverMetadataNew.class);

  private final Map<String, Map<String, List<SegmentWithState>>> segments;
  private final Map<String, Map<String, String>> lastSegmentIds;
  private final Object callerMetadata;

  @JsonCreator
  public AppenderatorDriverMetadataNew(
      @JsonProperty("segments") Map<String, Map<String, List<SegmentWithState>>> segments,
      @JsonProperty("lastSegmentIds") Map<String, Map<String, String>> lastSegmentIds,
  ...
  )
  {
    ...
    if (segments == null) {
      ...
      */
      log.error("WTF NULL SEGMENTS IN APPENDERATORDRIVERMETADATANEW");
      this.segments = null;
    } else {
  ...
  public AppenderatorDriverMetadataNew(
      Map<String, Map<String, List<SegmentWithState>>> segments,
      Map<String, Map<String, String>> lastSegmentIds,
  ...
  @JsonProperty
  public Map<String, Map<String, List<SegmentWithState>>> getSegments()
  {
    return segments;
  }

  @JsonProperty
  public Map<String, Map<String, String>> getLastSegmentIds()
  {
  ...
  {
    return "AppenderatorDriverMetadataNew{" +
           "segments=" + segments +
