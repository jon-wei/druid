...
{
  public static String PROPERTY = "druid.auth.authorizationManager";
  @Override
  public void configure(Binder binder)
  {
    PolyBind.createChoiceWithDefault(
        ...
        Key.get(DefaultAuthorizationManager.class),
        "default"
    );
    ...
    authorizationManagerMapBinder.addBinding("default").to(DefaultAuthorizationManager.class).in(LazySingleton.class);
  }
}
