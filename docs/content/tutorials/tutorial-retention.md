...
```
bin/post-index-task --file quickstart/retention-index.json 
```
...
The next page (http://localhost:8081/#/datasources/retention-tutorial) provides information about what segments a datasource contains. On the left, the page shows that there are 22 segments, each one containing data for a specific hour of 2016-06-27:

![Original segments](../tutorials/img/tutorial-retention-01.png "Original segments")

## Set retention rules

Suppose we want to drop data for the first 12 hours of 2016-06-27 and keep data for the later 12 hours of 2016-06-27.
...
The segments for the first 12 hours of 2016-06-27 are now gone:
...
```
loadByInterval 2016-06-27T12/2016-06-28 (12 hours)
