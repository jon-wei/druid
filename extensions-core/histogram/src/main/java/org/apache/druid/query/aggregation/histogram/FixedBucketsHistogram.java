...
public class FixedBucketsHistogram
{
  ...
  public void combineHistogramSameBuckets(FixedBucketsHistogram otherHistogram)
  {
  ...
  public void combineHistogramDifferentBuckets(FixedBucketsHistogram otherHistogram)
  {
    long otherCount;
        ...
        if (Math.round(fractionalCount) > 0) {
          ...
          */
          ...
          if (minStride >= theirCursor) {
            ...
            /*
            log.info(
                "--------SET MIN------ FRACCOUNT: %s, FRAC: %s, IBS: %s, MSN: %s",
                fractionalCount,
                fractional,
                intraBucketStride,
                minStride
          ...
          if (maxStride < theirCursor + toConsume) {
            ...
            /*
            log.info(
                "--------SET MAX------ FRACCOUNT: %s, FRAC: %s, IBS: %s, XSN: %s",
                fractionalCount,
                fractional,
                intraBucketStride,
                maxStride
