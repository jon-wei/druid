...
public class HllSketchIntermediateSqlAggregator implements SqlAggregator
{
  private static final SqlAggFunction FUNCTION_INSTANCE = new HllSketchIntermediateSqlAggFunction();
  private static final String NAME = "DS_HLL_BUILD";
  ...
  private static class HllSketchIntermediateSqlAggFunction extends SqlAggFunction
  {
    private static final String SIGNATURE = "'" + NAME + "(column, lgK, tgtHllType)'\n";

    HllSketchIntermediateSqlAggFunction()
    {
      super(
          NAME,
          null,
