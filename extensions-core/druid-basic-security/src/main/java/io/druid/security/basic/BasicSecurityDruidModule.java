...
import io.druid.security.basic.authorization.BasicRBACAuthorizationManager;
...
public class BasicSecurityDruidModule implements DruidModule
{
  ...
  {
    JsonConfigProvider.bind(binder, "druid.basic.security", BasicSecurityConfig.class);

    PolyBind.optionBinder(binder, Key.get(AuthorizationManager.class))
            .addBinding("basic")
            .to(BasicRBACAuthorizationManager.class)
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new SimpleModule("BasicDruidSecurity").registerSubtypes(
            ...
            BasicRBACAuthorizationManager.class
        )
    );
  }
}
