...
import io.druid.security.basic.BasicSecurityConfig;
...
public class BasicHTTPAuthenticator implements Authenticator
{
  ...
  public BasicHTTPAuthenticator(
    ...
    @JacksonInject BasicSecurityConfig basicSecurityConfig
  )
  {
  ...
  public HttpClient createInternalClient(HttpClient baseClient)
  {
    return new CredentialedHttpClient(
        new BasicCredentials(basicSecurityConfig.getSystemPrincipal(), basicSecurityConfig.getSystemPrincipalSecret()),
        baseClient
    );
  }
